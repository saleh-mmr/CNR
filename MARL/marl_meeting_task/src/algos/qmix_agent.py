...
class QMIXAgent:
    ...
    def __init__(
        ...
        input_dim : int
            Dimension of cartepole observation vector (default: 4)
        ...
        self.input_dim = input_dim + n_agents  # Final input dim (cartepole + one-hot agent_id)
        self.num_actions = num_actions
        
        # Agent Q-network (main)
        # Note: input_dim includes cartepole observation + one-hot agent_id
    ...
    def _append_agent_id(self, obs):
        ...
        # Concatenate cartepole observation with one-hot agent_id
