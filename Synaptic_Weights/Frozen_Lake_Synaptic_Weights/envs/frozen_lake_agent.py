...
from controller.frozen_lake_weight_controller_tracking import ManhattanWeightController
...
class DQNAgent:
    ...
    def learn(self, batch_size, ap_index, step_counter):
        ...
        self.weight_controller.step(ap_index=ap_index, step_counter=step_counter)
        return None
